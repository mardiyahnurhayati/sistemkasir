...
<head>
	...
	<title>Lumino - Dashboard <?php echo ucfirst($this->session->userdata('admin_type'));?></title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="<?php echo site_url('Admin')?>"><em class="fa fa-dashboard">&nbsp;</em> Beranda</a></li>
			<li><a href="<?php echo site_url('Admin/tampil_motor')?>"><em class="fa fa-toggle-off">&nbsp;</em> Data Motor</a></li>
			<li><a href="<?php echo site_url('Admin/tampil_kasir')?>"><em class="fa fa-toggle-off">&nbsp;</em> Data User</a></li>
